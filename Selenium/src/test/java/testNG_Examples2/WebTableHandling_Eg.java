...
public class WebTableHandling_Eg {
	WebDriver driver;
  ...
  public void f() {
	  ...
	  for(int i=0;i<sizeR;i++) {
		  List<WebElement> currentRow=row.get(i).findElements(By.tagName("td")); // getting the contents of the ith row in the List currentRow
		  for(int j=0;j<sizeC;j++) {
			  String s=currentRow.get(j).getText();	//getting each(jth) coulmn value from currentRow
			  System.out.print(s);
		  }
		  System.out.println();
		  System.out.println(".........................................");
